(function(){
    ...
    this.sloths = [];
    this.sloths.push( new SlothVolleyball.Sloth([0 + (this.DIM_X/4), this.DIM_Y], this));
    this.sloths.push( new SlothVolleyball.Sloth([this.DIM_X - (this.DIM_X/4), this.DIM_Y], this));
	};
